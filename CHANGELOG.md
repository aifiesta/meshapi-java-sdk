...
- `RouterSvcApiError` extends `RuntimeException` with `status`, `errorCode`, `requestId`, `details`, `retryAfterSeconds`
...
- `X-RouterSVC-SDK: java/0.1.0` header on every request
