...
public class HttpClient {
    ...
    private static final String SDK_VERSION_HEADER = "X-RouterSVC-SDK";
    ...
    public Iterator<ChatCompletionChunk> stream(String path, Object body) {
        try {
            ...
            if (response.statusCode() >= 400) {
                ...
                throw RouterSvcApiError.fromResponse(errResp);
            }
    ...
    private <T> T execute(HttpRequest req, Class<T> responseType) {
        ...
        if (response.statusCode() >= 400) {
            throw RouterSvcApiError.fromResponse(response);
        }
        ...
        try {
            ...
            throw new RouterSvcApiError("JSON parse error: " + e.getMessage(),
                    response.statusCode(), "parse_error", "", null, null);
        }
    }
    ...
    private static <T> HttpResponse<String> toStringResponse(HttpResponse<T> original, String body) {
        // Adapter to reuse RouterSvcApiError.fromResponse(HttpResponse<String>)
